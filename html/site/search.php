                                ...
                                <ul class="nav sf-menu clearfix">
                                    ...
                                    <li class="sub-menu"><a href="index-1.html">About us</a><span></span>
                                        <ul class="submenu">
                                            ...
                                            <li><a href="#">Columns 03<span></span></a>
                                                <ul class="submenu">
    ...
    <div class="container">
        <div class="row">
            <section class="newsletter-box clearfix">
                ...
                <article class="col-lg-4 col-md-5 col-sm-6">
                    <form id="newsletter" accept-charset="utf-8">
        				<div class="success">Your subscribe request has been sent!</div>
        			    <label class="email">
        			    	<input type="email" class="form-control" value="Enter your email here">
